  ...
  return (
    <div className="flex flex-col gap-4 w-full" id="faq-section" aria-label="Perguntas Frequentes">
      <div className="flex items-center gap-2 mb-2 border-l-4 border-[var(--brand-cyan)] pl-3">
        ...
        <h3 className="text-[var(--text-primary)] font-bold text-lg tracking-wide uppercase">
        ...
        {siteContent.contactPage.faq.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <span className="text-[var(--text-primary)] font-bold text-sm sm:text-base leading-snug tracking-wide transition-colors duration-200 group-hover:text-[var(--brand-cyan)]">
                  {item.question}
                </span>
              ...
              <AnimatePresence initial={false}>
                {isOpen && (
                  ...
                  >
                    <div className="px-5 pb-5 pt-2 text-[var(--text-secondary)] text-sm leading-relaxed font-medium border-t border-[var(--border-subtle)]">
                      {item.answer}
                    </div>
                  </motion.div>
                )}
