...
import { Container, ButtonLink, Badge, Card } from './ui';
...
export default function HeroSection() {
  ...
  return (
    <section 
      className="py-10 lg:py-20 border-b border-[var(--border-subtle)] relative"
      ...
      <Container size="xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative w-full flex items-center justify-center">
            ...
            {/* Visual Composition Container using Card variant="glass" */}
            <Card 
              variant="glass"
              className="relative w-full max-w-[400px] h-[360px] sm:h-[420px] rounded-2xl overflow-hidden p-6 flex flex-col justify-between bg-[var(--surface-glass-strong)] backdrop-blur-[16px] border border-[var(--border-subtle)] shadow-[var(--shadow-soft)]"
            >
