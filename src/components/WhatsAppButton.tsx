...
export default function WhatsAppButton() {
  const defaultMessage = "Olá! Conheci o site da +Seven e gostaria de mais informações.";
  const encodedMessage = encodeURIComponent(defaultMessage);
  const whatsappUrl = `https://wa.me/${siteContent.contact.whatsapp}?text=${encodedMessage}`;
