    ...
    <div className="relative min-h-screen bg-[#050B16] pt-24 pb-12 overflow-hidden">
      ...
      <div className="page-shell">
        ...
        <Section spacing="compact" className="border-b border-white/5">
          <Container size="xl">
            <AnimatedSection className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <Container size="xl">
            <AnimatedSection>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  <Card variant="solid" className="p-8 flex flex-col h-full group border-inherit transition-colors duration-300">
                    ...
                    <CardTitle as="h3" className="mb-3">Escutamos</CardTitle>
                    <CardDescription>
                ...
                >
                  <Card variant="solid" className="p-8 flex flex-col h-full group border-inherit transition-colors duration-300">
                    ...
                    <CardTitle as="h3" className="mb-3">Construímos</CardTitle>
                    <CardDescription>
                ...
                >
                  <Card variant="solid" className="p-8 flex flex-col h-full group border-inherit transition-colors duration-300">
                    ...
                    <CardTitle as="h3" className="mb-3">Acompanhamos</CardTitle>
                    <CardDescription>
