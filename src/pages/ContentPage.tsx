      ...
      <div className="page-shell">
              ...
              <div className="lg:col-span-7 flex flex-col gap-4 text-left">
                ...
                <div className="flex items-center gap-4 mt-2">
                  <button
                    ...
                    className="px-5 py-3 rounded-lg type-button text-white bg-[#095BFF] hover:bg-[#095BFF]/95 transition-all flex items-center gap-2 shadow-md shadow-[#095BFF]/15 cursor-pointer"
                  >
          ...
          {filteredContents.length === 0 ? (
            <div className="text-center py-12 glass-panel border-dashed max-w-lg mx-auto">
              ...
              <button
                ...
                className="mt-4 px-4 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 text-[#B6BEC8] hover:text-white type-button transition-all"
              >
                Limpar filtros
              </button>
            </div>
              ...
              {filteredContents.map((item) => (
                ...
                >
                  <div>
                    ...
                    <h4 className="text-white type-card-title mb-2 group-hover:text-[#16BDF0] transition-colors">
                      {item.title}
                    </h4>
                    <p className="text-[#B6BEC8] type-body-small mb-6 line-clamp-3">
                      {item.description}
                    </p>
                  </div>
        ...
        <AnimatedSection className="py-16 border-b border-white/5">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <span className="text-[#16BDF0] type-eyebrow">RECURSOS DE SUPORTE</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div className="flex items-center gap-4 text-left">
                ...
                <div>
                  <h4 className="text-white type-card-title mb-0.5">{siteContent.contentPage.materials[0].title}</h4>
                  <p className="text-[#7F8A98] type-body-small">{siteContent.contentPage.materials[0].description}</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-4 text-left">
                ...
                <div>
                  <h4 className="text-white type-card-title mb-0.5">{siteContent.contentPage.materials[1].title}</h4>
                  <p className="text-[#7F8A98] type-body-small">{siteContent.contentPage.materials[1].description}</p>
                </div>
              </div>
              <ChevronRight className="w-5 h-5 text-[#7F8A98] group-hover:text-white transition-colors" />
            </motion.div>
            ...
            >
              <div className="flex items-center gap-4 text-left">
                ...
                <div>
                  <h4 className="text-white type-card-title mb-0.5">{siteContent.contentPage.materials[2].title}</h4>
                  <p className="text-[#7F8A98] type-body-small">{siteContent.contentPage.materials[2].description}</p>
                </div>
              </div>
              <ChevronRight className="w-5 h-5 text-[#7F8A98] group-hover:text-white transition-colors" />
            </motion.div>
                ...
                <form onSubmit={handleNewsletterSubmit} className="flex flex-col gap-3">
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      className="px-4 py-3 text-sm glass-input shrink-0 sm:flex-1 font-normal"
                    />
                    <button
                      type="submit"
                      className="px-5 py-3 rounded-lg bg-[#095BFF] hover:bg-[#095BFF]/95 text-white type-button transition-all whitespace-nowrap"
                    >
                      Quero receber
                    </button>
                  </div>
          ...
          <div className="w-full max-w-2xl bg-[#07111F] border border-[#16BDF0]/30 rounded-2xl p-6 sm:p-8 shadow-2xl relative overflow-hidden flex flex-col max-h-[85vh]">
            ...
            <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-4">
              <div className="flex flex-col gap-1 text-left">
                ...
                <h3 className="text-white type-card-title">
                  {activeArticle.title}
                </h3>
              </div>
              <button
            ...
            <div className="border-t border-white/10 pt-4 mt-4 flex items-center justify-between">
              ...
              <button
                ...
                className="px-4 py-2.5 bg-[#095BFF] hover:bg-[#095BFF]/95 text-white type-button rounded-lg transition-all"
              >
                Agendar diagnóstico
              </button>
            </div>
