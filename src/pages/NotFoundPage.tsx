  ...
  return (
    <div className="relative min-h-screen bg-[#050B16] flex items-center justify-center py-20 overflow-hidden">
      ...
      <div className="page-shell max-w-md text-center flex flex-col items-center gap-6">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-xl type-button text-white bg-[#095BFF] hover:bg-[#095BFF]/95 shadow-lg shadow-[#095BFF]/20 active:scale-98 transition-all"
        >
