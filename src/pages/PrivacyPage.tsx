...
import { Container, Section, Card, CardTitle, CardDescription } from '../components/ui';
      ...
      <Section className="page-shell">
        <Container size="md">
          <AnimatedSection>
            ...
            {/* Content Box */}
            <Card variant="soft" className="p-6 sm:p-10 text-left flex flex-col gap-6">
              ...
              <div>
                <CardTitle as="h3" className="mb-2">1. Dados Coletados</CardTitle>
                <CardDescription className="text-[#B6BEC8] type-body">
              ...
              <div>
                <CardTitle as="h3" className="mb-2">2. Finalidade do Contato</CardTitle>
                <CardDescription className="text-[#B6BEC8] type-body">
              ...
              <div>
                <CardTitle as="h3" className="mb-2">3. Armazenamento e Segurança</CardTitle>
                <CardDescription className="text-[#B6BEC8] type-body">
              ...
              <div>
                <CardTitle as="h3" className="mb-2">4. Direitos do Titular</CardTitle>
                <CardDescription className="text-[#B6BEC8] type-body">
              ...
              <div>
                <CardTitle as="h3" className="mb-2">5. Cookies</CardTitle>
                <CardDescription className="text-[#B6BEC8] type-body">
