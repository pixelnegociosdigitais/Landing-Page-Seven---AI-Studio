  ...
  return (
    <div className="relative min-h-screen bg-[#050B16] pt-32 pb-20 overflow-hidden">
      ...
      <AnimatedSection className="page-shell max-w-4xl">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-xs font-bold text-[#16BDF0] hover:text-white transition-colors mb-8 group"
        >
        ...
        <div className="flex items-center gap-4 mb-8 text-left">
          ...
          <div>
            <h1 className="text-white font-bold text-2xl sm:text-3xl tracking-tight leading-none">
              Política de Privacidade
            </h1>
            <p className="text-[#7F8A98] text-xs font-medium mt-1.5 uppercase tracking-wider">
        ...
        {/* Content Box */}
        <div className="glass-panel p-6 sm:p-10 border-white/5 bg-[rgba(10,27,48,0.45)] text-left flex flex-col gap-6 text-sm sm:text-base text-[#B6BEC8] leading-relaxed font-medium">
          
          <div className="border-b border-white/5 pb-4">
            <span className="text-xs text-[#16BDF0] font-bold uppercase tracking-widest block mb-2">Aviso Legal Importante</span>
            <p className="text-xs text-[#7F8A98] italic font-semibold">
          ...
          <div>
            <h3 className="text-white font-bold text-base mb-2">1. Dados Coletados</h3>
            <p>
          ...
          <div>
            <h3 className="text-white font-bold text-base mb-2">2. Finalidade do Contato</h3>
            <p>
          ...
          <div>
            <h3 className="text-white font-bold text-base mb-2">3. Armazenamento e Segurança</h3>
            <p>
          ...
          <div>
            <h3 className="text-white font-bold text-base mb-2">4. Direitos do Titular</h3>
            <p>
              Em conformidade com as diretrizes da Lei Geral de Proteção de Dados (LGPD), você pode solicitar a qualquer momento a consulta, correção, bloqueio ou eliminação definitiva dos seus dados de nosso banco de contatos. Para isso, basta nos enviar uma mensagem formal através do e-mail <a href="mailto:contato@maisseven.com.br" className="text-[#16BDF0] hover:underline font-bold">contato@maisseven.com.br</a>.
            </p>
          </div>

          <div>
            <h3 className="text-white font-bold text-base mb-2">5. Cookies</h3>
            <p>
